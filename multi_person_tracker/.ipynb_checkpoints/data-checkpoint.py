...
def video_to_images(vid_file, img_folder=None, return_info=False, event_range_tuple=None):
    ...
    if event_range_tuple is not None:
        command = ['ffmpeg',
                   '-ss', event_range_tuple[0],
                   '-i', vid_file,
                   '-f', 'image2',
                   '-v', 'error',
                   '-s', '960x540',
                   '-t', event_range_tuple[1],
                   f'{img_folder}/%06d.png']
